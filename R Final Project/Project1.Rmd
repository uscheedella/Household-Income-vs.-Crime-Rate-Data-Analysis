...
CommunityData = subset(CommunityDataTemp, select = -c(PERCENT.OF.HOUSING.CROWDED,PERCENT.HOUSEHOLDS.BELOW.POVERTY,PERCENT.AGED.16..UNEMPLOYED,PERCENT.AGED.25..WITHOUT.HIGH.SCHOOL.DIPLOMA,PERCENT.AGED.UNDER.18.OR.OVER.64) )
...
citydata = subset(citydata, select = -c(Case.Number,ID,Block,IUCR,Description,Location.Description,Beat,Ward,FBI.Code,X.Coordinate,Y.Coordinate,Updated.On,Location) )
...
#Finds the top crimes ove the entire period for ENTIRE MASTER DATA SET
...
MasterDataTable = subset(MasterDataTable,Freq > 1000) # Make it so we only consider crimes that have more than 1000 occurances


p<-ggplot(data=MasterDataTable, aes(x=Var1, y=Freq)) +
  geom_bar(stat="identity", fill="steelblue")+
  theme_minimal()
p + theme(text = element_text(size=8),axis.text.x = element_text(angle = 90, hjust = 1))+ xlab("Type of Crime") + ylab("Number of occurances") + ggtitle("Number of Occurances of Different Types of Crimes in Chicago (> 1000 occurances)")
...
p<-ggplot(data=MasterDataTable1, aes(x=Var1, y=Freq)) +
  geom_bar(stat="identity", fill="steelblue")+
  theme_minimal()
p + theme(text = element_text(size=8),axis.text.x = element_text(angle = 90, hjust = 1))+ xlab("Type of Crime") + ylab("Number of occurances") + ggtitle("Number of Occurances of Different Types of Crimes in Chicago (> 1000 occurances) in Years 2001 to 2003")
...
MasterDataTable2 = subset(MasterDataTable2,Freq > 1000) # Make it so we only consider crimes that have more than 1000 occurances


p<-ggplot(data=MasterDataTable2, aes(x=Var1, y=Freq)) +
  geom_bar(stat="identity", fill="steelblue")+
  theme_minimal()
p + theme(text = element_text(size=8),axis.text.x = element_text(angle = 90, hjust = 1))+ xlab("Type of Crime") + ylab("Number of occurances") + ggtitle("Number of Occurances of Different Types of Crimes in Chicago (> 1000 occurances) for Years 2013 to 2015")
...
p+ geom_vline(aes(xintercept=mean(Time)),color="blue", linetype="dashed", size=1)+ ggtitle("Total Crime Per Hour for Years 2001 - 2017")
ggplot(MasterData, aes(x=Time))+geom_histogram(color="darkblue", fill="lightblue") + ggtitle("Total Crime Per Hour for Years 2001 - 2017")

#Plot of Theft crime over time
HistTheft = subset(MasterData,MasterData$Primary.Type == 'THEFT')
ggplot(HistTheft, aes(x=Time))+geom_histogram(color="darkblue", fill="lightblue") + ggtitle("Theft Crime Total Per Hour for Years 2001 - 2017")

#Plot of Battery crime over time
HistBattery = subset(MasterData,MasterData$Primary.Type == 'BATTERY')
ggplot(HistBattery, aes(x=Time))+geom_histogram(color="darkblue", fill="lightblue") + ggtitle("Battery Crime Total Per Hour for Years 2001 - 2017")

#Plot of Criminal Damage crimes over time
HistCriminal = subset(MasterData,MasterData$Primary.Type == 'CRIMINAL DAMAGE')
ggplot(HistCriminal, aes(x=Time))+geom_histogram(color="darkblue", fill="lightblue") + ggtitle("Criminal Damage Crime Total Per Hour for Years 2001 - 2017")

#Plot of Narcotics crimes over time
HistNarcotics = subset(MasterData,MasterData$Primary.Type == 'NARCOTICS')
ggplot(HistNarcotics, aes(x=Time))+geom_histogram(color="darkblue", fill="lightblue") + ggtitle("Narcotics Crime Total Per Hour for Years 2001 - 2017")
...
p+ geom_vline(aes(xintercept=mean(Time)),color="blue", linetype="dashed", size=1)+ ggtitle("Total Crime Per Hour for Years 2001 - 2003")
ggplot(MasterDataSection1, aes(x=Time))+geom_histogram(color="darkblue", fill="lightblue") + ggtitle("Total Crime Per Hour for Years 2001 - 2003")

#Plot of Theft crime over time
HistTheft1 = subset(MasterDataSection1,MasterDataSection1$Primary.Type == 'THEFT')
ggplot(HistTheft1, aes(x=Time))+geom_histogram(color="darkblue", fill="lightblue") + ggtitle("Theft Crime Total Per Hour for Years 2001 - 2003")

#Plot of Battery crime over time
HistBattery1 = subset(MasterDataSection1,MasterDataSection1$Primary.Type == 'BATTERY')
ggplot(HistBattery1, aes(x=Time))+geom_histogram(color="darkblue", fill="lightblue") + ggtitle("Battery Crime Total Per Hour for Years 2001 - 2003")

#Plot of Criminal Damage crimes over time
HistCriminal1 = subset(MasterDataSection1,MasterDataSection1$Primary.Type == 'CRIMINAL DAMAGE')
ggplot(HistCriminal1, aes(x=Time))+geom_histogram(color="darkblue", fill="lightblue") + ggtitle("Criminal Damage Crime Total Per Hour for Years 2001 - 2003")

#Plot of Narcotics crimes over time
HistNarcotics1 = subset(MasterDataSection1,MasterDataSection1$Primary.Type == 'NARCOTICS')
ggplot(HistNarcotics, aes(x=Time))+geom_histogram(color="darkblue", fill="lightblue") + ggtitle("Narcotics Crime Total Per Hour for Years 2001 - 2003")
...
p+ geom_vline(aes(xintercept=mean(Time)),color="blue", linetype="dashed", size=1)+ ggtitle("Total Crime Per Hour for Years 2013 - 2016")
ggplot(MasterDataSection2, aes(x=Time))+geom_histogram(color="darkblue", fill="lightblue") + ggtitle("Total Crime Per Hour for Years 2013 - 2016")

#Plot of Theft crime over time
HistTheft2 = subset(MasterDataSection2,MasterDataSection2$Primary.Type == 'THEFT')
ggplot(HistTheft2, aes(x=Time))+geom_histogram(color="darkblue", fill="lightblue") + ggtitle("Theft Crime Total Per Hour for Years 2013 - 2016")

#Plot of Battery crime over time
HistBattery2 = subset(MasterDataSection2,MasterDataSection2$Primary.Type == 'BATTERY')
ggplot(HistBattery2, aes(x=Time))+geom_histogram(color="darkblue", fill="lightblue") + ggtitle("Battery Crime Total Per Hour for Years 2013 - 2016")

#Plot of Criminal Damage crimes over time
HistCriminal2 = subset(MasterDataSection2,MasterDataSection2$Primary.Type == 'CRIMINAL DAMAGE')
ggplot(HistCriminal2, aes(x=Time))+geom_histogram(color="darkblue", fill="lightblue") + ggtitle("Criminal Damage Crime Total Per Hour for Years 2013 - 2016")
...
ggplot(HistNarcotics2, aes(x=Time))+geom_histogram(aes(y =..density..), 
                 breaks=seq(0, 23, by = 1),color="darkblue", fill="lightblue",alpha=.2) + geom_density(col=2) + ggtitle("Narcotics Crime Total Per Hour for Years 2013 - 2016")
...
ggplot(numvector, aes(x=CommunityArea, y=Number)) + geom_bar(stat = "identity") + ggtitle("Number of Crime Ocurrances Per Community Area from 2001 to 2017") + xlab("Commmunity Areas")
...
ggplot(numvector1, aes(x=CommunityArea, y=Number)) + geom_bar(stat = "identity") + ggtitle("Number of Crime Ocurrances Per Community Area from 2001 to 2003") + xlab("Commmunity Areas")
...
ggplot(numvector2, aes(x=CommunityArea, y=Number)) + geom_bar(stat = "identity") + ggtitle("Number of Crime Ocurrances Per Community Area from 2013 to 2015") + xlab("Commmunity Areas") + geom_density()
...
Battery2001 = subset(MasterData, MasterData$Year =='2001' & MasterData$Primary.Type == 'BATTERY', select = c(Primary.Type))
Battery2001 = nrow(Battery2001)
Battery2006 = subset(MasterData, MasterData$Year =='2006' & MasterData$Primary.Type == 'BATTERY', select = c(Primary.Type))
Battery2006 = nrow(Battery2006)
Battery2011 = subset(MasterData, MasterData$Year =='2011' & MasterData$Primary.Type == 'BATTERY', select = c(Primary.Type))
Battery2011 = nrow(Battery2011)
Battery2016 = subset(MasterData, MasterData$Year =='2016' & MasterData$Primary.Type == 'BATTERY', select = c(Primary.Type))
Battery2016 = nrow(Battery2016)
Batteryvector = c(Battery2001,Battery2006,Battery2011,Battery2016)

Criminal2001 = subset(MasterData, MasterData$Year =='2001' & MasterData$Primary.Type == 'CRIMINAL DAMAGE', select = c(Primary.Type))
Criminal2001 = nrow(Criminal2001)
Criminal2006 = subset(MasterData, MasterData$Year =='2006' & MasterData$Primary.Type == 'CRIMINAL DAMAGE', select = c(Primary.Type))
Criminal2006 = nrow(Criminal2006)
Criminal2011 = subset(MasterData, MasterData$Year =='2011' & MasterData$Primary.Type == 'CRIMINAL DAMAGE', select = c(Primary.Type))
Criminal2011 = nrow(Criminal2011)
Criminal2016 = subset(MasterData, MasterData$Year =='2016' & MasterData$Primary.Type == 'CRIMINAL DAMAGE', select = c(Primary.Type))
...
ggplot(data=Theftvector, aes(x=Year, y=Number, group=1)) + geom_line() + geom_point()  +ggtitle("Theft Crimes from 2001 to 2016")
ggplot(data=Batteryvector, aes(x=Year, y=Number, group=1)) + geom_line() + geom_point()  +ggtitle("Battery Crimes from 2001 to 2016")
ggplot(data=Criminalvector, aes(x=Year, y=Number, group=1)) + geom_line() + geom_point()  +ggtitle("Criminal Damage Crimes from 2001 to 2016")
ggplot(data=Narcoticsvector, aes(x=Year, y=Number, group=1)) + geom_line() + geom_point()  +ggtitle("Narcotics Crimes from 2001 to 2016")
...
ggplot(data=Theftvectorall, aes(x=YearsAll, y=Number, group=1)) + geom_line() + geom_point()  +ggtitle("Theft Crimes from 2001 to 2016")
...
colnames(Theftvectorall)[2] = "Number"
ggplot(data=Batteryvectorall, aes(x=YearsAll, y=Number, group=1)) + geom_line() + geom_point()  +ggtitle("Theft Crimes from 2001 to 2016")
...
ggplot(data=Narcoticsvectorall, aes(x=YearsAll, y=Number, group=1)) + geom_line() + geom_point()  +ggtitle("Narcotics Crimes from 2001 to 2016")
...
ggmap(chicago) +geom_density_2d(data = MasterData,aes(x = Longitude,y = Latitude))+geom_density_2d(data = D18,aes(x = Longitude,y = Latitude))

ggmap(chicago) +stat_density_2d(data = MasterData,aes(x = Longitude,y = Latitude,fill = stat(level)),alpha = .2,bins = 25,geom = "polygon") + scale_fill_gradientn(colors = brewer.pal(7, "YlOrRd"))
